...
namespace sysnova.Infrastructure.EventBroker
{
    public static class EventBrokerExtensionMethods
    {
        ...
        {
            bindingRoot.Bind<IEventBroker>().To<Appccelerate.EventBroker.EventBroker>().InThreadScope().Named(eventBrokerName); //InSingletonScope() Global. Captura Eventos Cross
        ...
        public static IBindingOnSyntax<T> OwnsEventBroker<T>(this IBindingOnSyntax<T> syntax, string eventBrokerName)
        {
            ...
            syntax.Kernel.Bind<IEventBroker>().To<Appccelerate.EventBroker.EventBroker>().InNamedScope(namedScopeName).Named(eventBrokerName);
